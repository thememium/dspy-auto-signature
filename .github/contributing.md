# AutoSignature Contributing Guide

Hi! I'm really excited that you are interested in contributing to AutoSignature. Before submitting your contribution, please make sure to take a moment and read through the following guidelines:
...
This is equivalent to `uv run src/dspy_auto_signature/__init__.py`.
...
# Run a specific test
$ uv run pytest tests/test_generator.py::TestAutoSignature -v
```
...
```
├── src/dspy_auto_signature/    # Source code
│   ├── __init__.py             # Main entry point and public API
│   ├── core/                   # Core configuration and signature building
│   │   ├── config.py           # Configuration and defaults
│   │   └── signature_builder.py # Signature construction logic
│   ├── generator/              # RLM-based signature generation
│   │   ├── rlm_signature_generator.py # Main generator implementation
│   │   └── rlm_signatures.py  # DSPy signatures for RLM prompts
│   ├── parser/                 # Input parsing
│   │   ├── base.py             # Base parser interface
│   │   ├── string_parser.py    # String/prompt parsing
│   │   ├── dataframe_parser.py # DataFrame parsing and profiling
│   │   └── vercel_parser.py    # Vercel AI SDK type parsing
│   ├── data/                   # Data handling
│   │   ├── profiler.py         # Dataset profiling and statistics
│   │   └── to_records.py       # Data conversion utilities
│   ├── types/                  # Type definitions
│   │   └── signature_spec.py   # Signature specification types
│   └── utils/                  # Utilities
│       └── type_resolver.py    # Type resolution and inference
├── tests/                      # Test files
└── dist/                       # Build output
```
...
- Use absolute imports from the `dspy_auto_signature` package for local modules
...
Thank you to all the people who have already contributed to AutoSignature!

<a href="https://github.com/thememium/dspy-auto-signature/graphs/contributors"><img src="https://contrib.rocks/image?repo=thememium/dspy-auto-signature" /></a>