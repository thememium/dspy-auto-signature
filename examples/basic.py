...
def main() -> None:
    ...
    with open(
        "examples/output/example_basic_rlm_signature.py", "w", encoding="utf-8"
    ) as f:
        f.write(sig.to_source())
    print("Saved signature to output/example_basic_rlm_signature.py")
    ...
    # 3. Save the generated signature to a file.
    with open(
        "examples/output/example_basic_determenistic_signature.py",
        "w",
        encoding="utf-8",
    ) as f:
        f.write(sig.to_source())
    print("Saved signature to output/example_basic_determenistic_signature.py")
